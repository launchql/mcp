# Starship MCP Tool - Configuration generation format and guide
...
> NOTE: Prerequisites include installing `cert-issuer` and `nginx-ingress` controller in the k8s cluster.
